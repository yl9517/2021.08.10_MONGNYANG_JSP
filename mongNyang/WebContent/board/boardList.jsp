	...
	<div id="boardWrap">
		...
		<div class="page1">
			<c:if test="${paging.startblock>1 }">
				<a href="boardlist.do?boardType=${boardType }&petAddr=${petAddr }&curr=${paging.prevPageblock }&search=${paging.search }&searchtxt=${paging.searchtxt }" class="next"> < </a>
			</c:if>
		</div>
		<div class="page2">
			<c:forEach var="index" begin="${paging.startblock }" end="${paging.endblock }">
				...
				<c:if test="${paging.currpage!=index }">
					<a href="boardlist.do?boardType=${boardType }&petAddr=${petAddr }&curr=${index }&search=${paging.search }&searchtxt=${paging.searchtxt }">${index }</a>
		...
		<div class="page3">
			<c:if test="${paging.endblock<paging.totalpage }">
				<a href="boardlist.do?boardType=${boardType }&petAddr=${petAddr }&curr=${paging.nextPageblock }&search=${paging.search }&searchtxt=${paging.searchtxt }" class="next">></a>
			</c:if>
		</div>
	</div>
